...
\begin{abstract}
    The \PackageName{versionchanges} package allows to keep a record of the changes in a document.
\end{abstract}
...
\VCChange{%
    ...
    version = 0.1h,
    removed,
    description = {Document Class: article 2022/07/02 v1.4n Standard LaTeX document class},
}%
This is old story.
...
\VCChange{%
    updated,
    version = 0.1h,
    description = {Document Class: article 2022/07/02 v1.4n Standard \LaTeX},
}%
\VCChange{%
    version = 1.2,
...
\VCChange{%
    version = 1.2,
    description = {new next a \textbf{jander}},
    type = new,
}%
This is new.
